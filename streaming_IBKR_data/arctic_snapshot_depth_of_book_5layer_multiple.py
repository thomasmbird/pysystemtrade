        ...
        try:
            ...
            with open(file_dir+self.localSymbol+'/'+file_name, "a", newline="") as filetowrite:
                ...
                if len(ticks.domTicks) != 0:
                    ...
                    print(self.localSymbol, 0, ticks.domTicks[0].time, ticks.domBids[0].size, ticks.domBids[0].price,
                          ticks.domAsks[0].price, ticks.domAsks[0].size)
            ...
            print(self.localSymbol, "Whole thing failed: ",e)
...
ib = IB()
ib.connect('127.0.0.1', 4001, clientId=41)
