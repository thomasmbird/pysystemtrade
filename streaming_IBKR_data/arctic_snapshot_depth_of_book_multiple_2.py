...
ib = IB()
ib.connect('127.0.0.1', 4001, clientId=39)

#contract = Stock('TSLA', 'SMART', 'USD')
file_dir = '/Users/thomasmbird/Documents/Quant Stuff/LiveMktData/TopOfBook/'
file_name_base = 'top_of_book_'

file_name= get_file_name(file_dir, file_name_base)

list_of_contracts = pd.read_csv('/Users/thomasmbird/Documents/Quant Stuff/LiveMktData/allbars_micro.csv')
