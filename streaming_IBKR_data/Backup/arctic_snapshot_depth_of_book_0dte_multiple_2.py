...
if __name__ == '__main__':
    ...
    #expiry = '20231120'
    expiry_list = ['20240124','20240125','20240126']
    ...
    strike_dict = {}
    strike_dict['Max'] = 5000
    strike_dict['Min'] = 4600
    ...
    ctr = 0
    for obj in obj_list:
        processlist.append(Process(target=start_run, args=((ctr,obj))))
        print("Counter: ",ctr)
        ctr+=1

    #proc2 = Process(target=start_run, args=(('2', )))
    ...
    print("Main thread now waiting 20s")
    tyme.sleep(20)
    print("Main thread now checking kiddos")
    for proc in processlist:
        proc.join()
