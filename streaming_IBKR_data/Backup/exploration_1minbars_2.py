...
ib = IB()
ib.connect('127.0.0.1', 4001, clientId=56)

#contract = Stock('TSLA', 'SMART', 'USD')
file_dir = '/Users/thomasmbird/Documents/Quant Stuff/LiveMktData/'
file = '1minbar_contracts_micro.csv'
...
print(symbol_df.head(5).to_string())
...
ic = 0
for contract in contract_object_list:
    try:
        ...
        #c#ontract = contract_object_list[ic]
