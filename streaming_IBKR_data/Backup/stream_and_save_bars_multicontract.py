...
class IBFutures(Contract):
    ...
    def onBarUpdate(self, bars, hasNewBar):
        ...
        try:
            lib.write(self.localSymbol+'_5sec_bars_test', [{'index': bardict['time'],
                                     'open': bardict['open_'],
                                     'high': bardict['high'],
                                     'low': bardict['low'],
                                     'close': bardict['close'],
...
file_dir = '/Users/thomasmbird/Documents/Quant Stuff/LiveMktData/CL/'
file_name_base = '5sec_bars_'

file_name= get_file_name(file_dir, file_name_base)

list_of_contracts = pd.read_csv('/Users/thomasmbird/Documents/Quant Stuff/LiveMktData/cl_contracts.csv')
