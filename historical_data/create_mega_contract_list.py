...
output_file = file_dir+'allbars_newrolls.csv'
file = 'allbars_newrolls.csv'
total_contr_list = []
for ic in range(0,symbol_df.shape[0]):
    try:
        ...
        contrtest = Contract(secType='FUT',symbol=sym,currency='USD',includeExpired=False)
